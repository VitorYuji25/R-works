...
# Os boxplots mostram a distribuição do comprimento das baleias para cada espécie.
# Cada caixa representa a distribuição dos comprimentos, onde a linha no meio é a mediana.
# As "caixas" dos boxplots mostram onde a maioria dos comprimentos está concentrada, enquanto
# as "linhas" se estendem para indicar a variação dos dados.
